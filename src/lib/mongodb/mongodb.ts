...
declare global {
  var nextme_master: Promise<MongoClient>
  var nextme_did: Promise<MongoClient>
  var nextme_api: Promise<MongoClient>
}

type DbType = 'nextme_master' | 'nextme_did' | 'nextme_api' | 'nextme_oa'
