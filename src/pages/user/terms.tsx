    ...
    <Layout customClass="max-w-screen-2k pt-2 px-4">
      ...
      <main className="w-11/12 sm:5/6 md:w-4/5 py-16 m-auto">
        ...
        <article className="prose max-w-none">
          ...
          <h2>Welcome to Nextme</h2>
          <p>
            These terms of service outline the rules and regulations for the use of Nextme's Website. By accessing this
            website we assume you accept these terms of service in full. Do not continue to use Nextme's website if you
          ...
          <h2>Cookies</h2>
          <p>
            We employ the use of cookies. By using Nextme's website you consent to the use of cookies in accordance with
            Nextme's privacy policy. Most of the modern day interactive web sites use cookies to enable us to retrieve
          ...
          <h2>License</h2>
          <p>
            Unless otherwise stated, Nextme and/or it's licensors own the intellectual property rights for all material
            on Nextme. All intellectual property rights are reserved. You may view and/or print pages from Nextme for
            your own personal use subject to restrictions set in these terms of service.
          </p>
          <strong>You must not:</strong>
          <ol>
            <li>Republish material from Nextme</li>
            <li>Sell, rent or sub-license material from Nextme</li>
            <li>Reproduce, duplicate or copy material from Nextme</li>
          </ol>
          <span>Redistribute content from Nextme (unless content is specifically made for redistribution).</span>
          <h2>User Comments</h2>
          <ol>
            <li>This Agreement shall begin on the date hereof.</li>
            <li>
              Certain parts of this website offer the opportunity for users to post and exchange opinions, information,
              material and data ('Comments') in areas of the website. Nextme does not screen, edit, publish or review
              Comments prior to their appearance on the website and Comments do not reflect the views or opinions of
              Nextme, its agents or affiliates. Comments reflect the view and opinion of the person who posts such view
              or opinion. To the extent permitted by applicable laws Nextme shall not be responsible or liable for the
            ...
            <li>
              Nextme reserves the right to monitor all Comments and to remove any Comments which it considers in its
            ...
            <li>
              You hereby grant to Nextme a non-exclusive royalty-free license to use, reproduce, edit and authorize
          ...
          <p>
            ...
            visibility associated with the hyperlink outweighs the absence of Nextme; and (d) where the link is in the
          ...
          <p>
            No use of Nextme's logo or other artwork will be allowed for linking absent a trademark license agreement.
          </p>
          <h2>Iframes</h2>
          <p>
